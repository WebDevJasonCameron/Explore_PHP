...
$localTag = '<span class="text-xs text-white bg-blue-500 rounded-full px-2 py-1 ml-2">Local</span>';
$remoteTag = '<span class="text-xs text-white bg-green-500 rounded-full px-2 py-1 ml-2">Remote</span>';
?>
            ...
            <ul class="mt-4">
              ...
              <li class="mb-2">
                <strong>Location:</strong> <?= $job['location'] ?>
                  <?= ($job['location'] === 'New York') ? $localTag : $remoteTag ?>
              </li>
